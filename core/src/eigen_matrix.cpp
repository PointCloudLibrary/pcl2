...
template class pcl2::ConstTypedMat<int>;

template class pcl2::TypedMat<float>;
template class pcl2::ConstTypedMat<float>;

template class pcl2::TypedMat<double>;
template class pcl2::ConstTypedMat<double>;


template class pcl2::EigenMat<int>;
template class pcl2::ConstEigenMat<int>;

template class pcl2::EigenMat<float>;
template class pcl2::ConstEigenMat<float>;

template class pcl2::EigenMat<double>;
template class pcl2::ConstEigenMat<double>;
