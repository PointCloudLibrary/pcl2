 ...
 * given in \f$ c_0 x + c_1 y + c_2 z = c_3 \f$ form
 */
MatF fitPlaneRANSAC (Cloud cloud, float inlier_threshold);
 ...
 * given in \f$ c_0 x + c_1 y + c_2 z = c_3 \f$ form
 */
MatF fitPlaneRANSAC (MatF points, float inlier_threshold);
}
